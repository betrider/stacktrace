...
void sampleMethod(){
  ...
  log("Source file: ${programInfo.fileName}"); // 호출한 파일명
  log("function: ${programInfo.functionName}"); // 호출한 함수명
  log("caller function: ${programInfo.callerFunctionName}"); // 함수를 호출한 함수명
  log("Number: ${programInfo.lineNumber}"); // CustomTrace 라인
}
